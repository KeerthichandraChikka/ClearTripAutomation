...
public class DataUtil {
	...
	public static boolean isSuiteRunnable(String suiteName) {
		...
		for (int rowNum = 2; rowNum <= rows; rowNum++) {
			...
			System.out.println("Data from isSuiteRunnable is: "+data);
		...
		System.out.println("Result from IsSuite Runnable is: "+result);
		return result;
	...
	public static boolean isTestRunnable(String testCaseName, ExcelReader excel) {
		...
		for (int rowNum = 2; rowNum <= rows; rowNum++) {
			...
			//System.out.println("Data from isTestRunnable at row num "+rowNum +" is: "+data);
